...
class ClientsList extends HTMLElement {
  ...
  async loadClients() {
    ...
    this.clients = data.clients.filter(remoteClient => remoteClient !== ClientsList.connection.id);
  }
  ...
  drawClients() {
    ...
    this.clients.forEach(client => {
      ...
      clientRow.innerText = client.length < 20 ? client : client.slice(0, 19) + '...';
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ClientsList);
...
class Interview extends HTMLElement {
  ...
  setControls(status) {
    ...
    controls.appendChild(status === 'working' ? this.stopInterviewButton : this.startInterviewButton);
...
/* harmony import */ var _components_Interview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Interview */ "./src/components/Interview.js");
/* harmony import */ var _components_ClientsList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/ClientsList */ "./src/components/ClientsList.js");
...
function createConnection(urlService) {
  const connection = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_0__.io)(urlService);
  return connection;
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createConnection);
